...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <aside
      className="hidden md:flex md:static inset-y-0 left-0 z-40 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex-col shrink-0"
    >
      {/* Brand Header */}
